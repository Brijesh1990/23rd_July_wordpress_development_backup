...
*Descriptions:Manage teams using core php with mysqli database 
*Version:1.0.0
...
register_activation_hook(__FILE__,'add_teams');

function ct_create_table()
{
    global $wpdb;
    $table=$wpdb->prifix . 'wp_';
...
{
include plugins_dir_path(__FILE__) .'admin/teams.php';    
}
